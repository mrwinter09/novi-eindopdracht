...
async function fetchingredientData(name) {
    try {
        const result = await _axiosDefault.default.get(`https://api.spoonacular.com/food/ingredients/search?apiKey=6f7619e16bca4d2d93898aa3d432b4dc&query=${name}`);
...
},{}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequire414a")
